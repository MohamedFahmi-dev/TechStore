        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordResetCodeExpiresOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarrantyInfo = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    CreatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                name: "HomepageSectionItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HomepageSectionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomepageSectionItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HomepageSectionItems_HomepageSections_HomepageSectionId",
                        column: x => x.HomepageSectionId,
                        principalTable: "HomepageSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HomepageSectionItems_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SKU = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    VariantLabel = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductVariantOptionValueId = table.Column<int>(type: "int", nullable: false),
                    CreatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariantValues_ProductVariantOptionValues_ProductVariantOptionValueId",
                        column: x => x.ProductVariantOptionValueId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomepageSectionItems_HomepageSectionId",
                table: "HomepageSectionItems",
                column: "HomepageSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_HomepageSectionItems_ProductId",
                table: "HomepageSectionItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_HomepageSections_Slug",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantValues_ProductVariantId_ProductVariantOptionValueId",
                table: "ProductVariantValues",
                columns: new[] { "ProductVariantId", "ProductVariantOptionValueId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantValues_ProductVariantOptionValueId",
                table: "ProductVariantValues",
                column: "ProductVariantOptionValueId");

            migrationBuilder.CreateIndex(
                name: "IX_RelatedProducts_ProductId_RelatedProductId_RelationType",
